...
\begin{titlepage}
  ...
  {\Large\bfseries ÉCOLE NATIONALE SUPÉRIEURE POLYTECHHIQUE DE YAOUNDÉ\par}
  \vspace{0.2cm}
  {\normalsize Département de Génie Informatique\par}
  {\normalsize Cycle des Ingénieurs du Numérique -- Filière : AIA4\par}
  \vspace{2cm}
  
  {\LARGE\bfseries\color{primary} RÉCAPITULATIF D'AVANCEMENT DES PROJETS\par}
  \vspace{0.5cm}
  {\large Bilan Intermédiaire, Objectifs Atteints et Difficultés Techniques\par}
  \vspace{0.2cm}
  ...
  \end{tabular}
  \vfill
  {\small Rapport d'avancement rédigé le 21 mai 2026\par}
\end{titlepage}
...
%  INTRODUCTION
%---------------------------------------------------------------
\section{État de Progression des Travaux}
...
\subsection{Objectifs Atteints}
\begin{itemize}
    \item \textbf{Indexation du catalogue (100\%) :} Constitution et redimensionnement d'une base de 150 vêtements, et écriture du pipeline d'indexation hors-ligne.
...
%---------------------------------------------------------------
%  CODE SOURCE ET REPOS DE TRAVAIL
%---------------------------------------------------------------
\section{Accès aux Codes Sources}

Les développements et les scripts de validation intermédiaire sont consultables en continu sur nos dépôts GitHub de travail :
\begin{itemize}
    \item \textbf{Projet 1 (Recommandation MovieLens) :} \url{https://github.com/neussi/movie_recommender}
    \item \textbf{Projet 2 (Moteur de Recherche Visuel CBIR) :} \url{https://github.com/neussi/visual_search_engine}
    \item \textbf{Projet 3 (Scoring Prédictif Bancaire) :} \url{https://github.com/neussi/bank_behavior_prediction}
\end{itemize}
